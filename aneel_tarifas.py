...
# Opcional: remover DATA_INICIO e DATA_FIM
#tarifas_mensal = tarifas_mensal.drop(columns=["DATA_INICIO","DATA_FIM"])

# ================= EXPORTAÇÃO 2 =================
tarifas_mensal.to_excel("Tarifas_Base_Mensal_ANEEL.xlsx", index=False)
